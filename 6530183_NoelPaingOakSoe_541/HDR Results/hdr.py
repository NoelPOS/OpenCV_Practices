...
img_fn = ["bottle1.jpg", "bottle2.jpg", "bottle3.jpg", "bottle4.jpg"]
...
cv.imwrite("Debevec_HDR.jpg", res_debevec_8bit)
cv.imwrite("Robertson_HDR.jpg", res_robertson_8bit)
cv.imwrite("Mertens_Fusion.jpg", res_mertens_8bit)
